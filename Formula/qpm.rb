class Qpm < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/MatheusQCardoso/homebrew-qpm/releases/download/1.0.0/qpm-1.0.0-darwin-arm64.tar.gz"
    sha256 "d3e5dd3f375804c355d458665696e865ba2248667d5be847c63f8bfafe3b5fe2"
  else
    url "https://github.com/MatheusQCardoso/homebrew-qpm/releases/download/1.0.0/qpm-1.0.0-darwin-amd64.tar.gz"
